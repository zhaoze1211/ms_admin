    ...
    <div class="my_order">
        <el-row style='padding: 10px 0;'>
            <el-col :span="7">
                ...
                <r-button type="primary" @click.native='order_export'>订单导出</r-button>
                <!--<a :href="getTitleHref" target="_blank" class='order_export'>订单导出</a>-->
                <r-button type="primary" @click.native='toImport'>批量发货</r-button>
            </el-col>
            <el-col :span="8">
                <div style="float: right;">
                    <r-date-picker v-model="dataObj.timeScopes" type="datetimerange" placeholder="订单时间范围" ref="dataObj"
                                   :editable="false">
                    </r-date-picker>
                </div>
            </el-col>
                    ...
                    <div v-for='o in orderList' class='orderNumber'>
                        <div class="border-b" v-if='o.xvporderitems'>
                            <r-myorder
                                    ...
                                    :customer-service='o.refund_status'
                                    :address-phone='o.address_phone'
                                    :address-name='o.address_name'
                                    :title='item.product_name'
                                    :order-num='o.order_id'
                                    ...
                                    :showaction='index'
                                    :ad-status='adStatusView(o.order_status).httxt'
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                utils.ajax({
                    ...
                    data: {
                        ...
                        "order_status": that.dataObj.optionsValue,
            ...
            tolook(obj) {
                utils.go('/order/toLookOrder/' + obj.orderNum, this.$router);
            },
            toImportAjax() {
                let that = this;
...
//            "elMenuItemGroup": require('../../components/menu/menu-item-group.vue'),
            ...
            "rMyorder": require('../../components/x-myOrder/main.vue'),
