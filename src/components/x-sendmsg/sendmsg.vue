...
<template>
	<div class="sendmsg">
		<!--工具栏-->
		<div class="toolbar">
			<a href="javascript:;" class="show-expression send-icon" @click="showExpression"></a>
			<a href="javascript:;" class="btn-upload send-icon">
				<input type="file" class="file" @change="upload" ref="file">
			</a>

			<div class="expression" :class="{'expression-act':showExp}">
				<div class="qq_face">
		...
		<!--输入框-->
		<div class="editor" contentEditable="true" @keydown.enter="sendEnter"></div>
		<!--输入框 end-->
		<div class="btn-wrapper">
			<el-button class="btn88" type="info" size="small" @click="sendClick">发送</el-button>
		</div>
...
<script>
	export default {
		...
		this.$nextTick(function () {
			...
			$(".qq_face a").click(function(e){
				var clazz_select = $(this).attr("class"),
						num = clazz_select.replace("face qqface",""),
						clazz = "qqemoji qqemoji"+num,
						text = $(this).attr("title");
				if(that.range){
					if(that.range.pasteHTML){
						var exp = '<img class="'+ clazz +'" src="'+that.space+'" text="['+text+']_web">';
						that.range.pasteHTML(exp);
					}else{
						var img = document.createElement("img");
						$(img).attr({"class":clazz,"src":that.space,"text":"["+text+"]_web"});
						that.range.surroundContents(img);
					}

				}else{
					var content = $(".editor").html() + exp;
					$(".editor").html(content);
				}
				e.stopPropagation();
			});
	...
	data() {
		return {
			"space":"data:image/png;base64,",
			"showExp":false,
			"range":null,
			"file":null
		}
...
//					}
		...
		sendMsg(){
			...
			content = content.replace( /<img[^>]+qqemoji[^>]+text="(\[[^\]]+\])[^>]+>/g ,"$1");
			content = content.replace(/(<(?!img)(?!br)[^>]*>)/ig, '');
			if(content == ""){
				this.$notify.error({
					title: '错误',
					message: '请输入要发送的内容'
			...
			this.$emit("send",{"type":"text","content":content});
			$(".editor").html("");

		},
		upload(){
			this.$emit("send",{"type":"file","content":this.$refs.file.files[0]});
		}
	},
	components: {
...
<style>
	@import "../../assets/styles/components/xsendmsg.less";
</style>