<template>
  <el-input
    :class="[type==='datetimerange'?'el-date-editor--datetimerange':'','el-date-editor']"
...
require("../../assets/styles/components/time-picker.less");
require("../../assets/styles/components/time-select.less");
require("../../assets/styles/components/date-picker.less");
</script>
