...
<script type="text/babel">
  ...
  import Locale from '../../libs/components/mixins/locale';
  import ElInput from '../input/input.vue';
  import ElSelectMenu from './select-dropdown.vue';
  import ElOption from '../option/option.vue';
  import ElTag from '../tag/tag.vue';
  import debounce from 'throttle-debounce/debounce';
  import Clickoutside from '../../libs/components/clickoutside';
  import {addClass, removeClass, hasClass} from 'wind-dom/src/class';
  import {addResizeListener, removeResizeListener} from '../../libs/components/resize-event';
  import {t} from '../../libs/components/locale/index';
  ...
  require("../../assets/styles/components/select.less");
</script>
